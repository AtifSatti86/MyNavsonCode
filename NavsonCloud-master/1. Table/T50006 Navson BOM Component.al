table 50006 "Navson BOM Component"
{
    Caption = 'Navson BOM Component';
    DrillDownPageID = "Navson Assembly BOM";
    LookupPageID = "Navson Assembly BOM";
    ...
    fields
    {
        ...
        field(15; "Parent Variant Code"; Code[10])
        {
            Caption = 'Parent Variant Code';
            TableRelation = "Item Variant".Code WHERE("Item No." = FIELD("Parent Item No."));
        ...
        {
            CalcFormula = Exist("Navson BOM Component" WHERE("Parent Item No." = FIELD("No."), "Parent Variant Code" = FIELD("Variant Code")));
    ...
    keys
    {
        key(Key1; "Parent Item No.", "Parent Variant Code", "Line No.")
        {
            Clustered = true;
        }
        key(Key2; Type, "No.")
    ...
    var
        ...
        BOMComp: Record "Navson BOM Component";
    ...
    local procedure OnAfterCopyFromItem(var BOMComponent: Record "Navson BOM Component"; Item: Record Item)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyFromResource(var BOMComponent: Record "Navson BOM Component"; Resource: Record Resource)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCopyFromItem(var BOMComponent: Record "Navson BOM Component"; xBOMComponent: Record "Navson BOM Component"; Item: Record Item; CallingFieldNo: Integer; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(true, false)]
    local procedure OnBeforeValidateAgainstRecursion(ItemNo: Code[20]; var IsHandled: Boolean; var BOMComponent: Record "Navson BOM Component")
    begin
    end;
}
