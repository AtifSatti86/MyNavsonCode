page 50020 "Navson Assembly BOM"
{
    AutoSplitKey = true;
    Caption = 'Navson Assembly BOM';
    DelayedInsert = true;
    DataCaptionFields = "Parent Item No.", "Parent Variant Code";
    PageType = List;
    RefreshOnActivate = true;
    SourceTable = "Navson BOM Component";
    ...
    layout
    {
        area(content)
        {
            ...
            field("Parent Variant Code"; rec."Parent Variant Code")
            {
                ApplicationArea = All;
                Editable = False;
            }
            repeater(Control1)
            {
                ...
                //Below fields are not used in Navson. Please don't make visible True
                /*
    ...
    actions
    {
        area(processing)
        {
            ...
            action(AssemblyBOM)
            {
                ...
                trigger OnAction()
                var
                    BOMComponent: Record "Navson BOM Component";
                begin
    ...
    local procedure OnBeforeCheckMandatoryRecFieldsBeforePageInsert(var BOMComponent: Record "Navson BOM Component"; var IsHandled: Boolean)
    begin
    end;
}
