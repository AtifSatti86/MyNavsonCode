report 50006 "Navson Customer Statement"
{
    Caption = 'Navson Customer Statement';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.", "Customer Finance Charges", "Search Name", "Print Statements", "Currency Filter";
            column(No_Cust; "No.")
            {
            }
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                if PrintLine then begin
                                    ...
                                    CustBalance := CustBalance + CustLedgerEntry."Remaining Amount";
                                    //Ashish 2022-11-10 +
            ...
            begin
                ...
                CompanyInfo.Get();
                if CompanyBankAccount.Get(Customer."Company Bank Account Code") then Begin
                    CompanyInfo."Bank Branch No." := CompanyBankAccount."Bank Branch No.";
                    CompanyInfo."Bank Name" := CompanyBankAccount.Name;
                    CompanyInfo."Bank Account No." := CompanyBankAccount."Bank Account No.";
                end;
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './3. Report Format/NavsonCustomerStatement.rdl';
        }
        layout(ReportWORD)
        {
            Type = word;
            LayoutFile = './3. Report Format/NavsonCustomerStatement.docx';
        }
    }
    ...
    begin
        ...
        StartDate := 20220101D;
        EndDate := Today;
        SupportedOutputMethod := SupportedOutputMethod::Preview;
