report 50009 "Custom Sales - Pro Forma Inv"
{
    DefaultLayout = RDLC;
    RDLCLayout = './3. Report Format/CustomSalesProFormaInv.rdlc';
    WordLayout = './3. Report Format/CustomSalesProFormaInv.docx';
    Caption = 'Navson Pro Forma Invoice';
    UsageCategory = None;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Navson Pro Forma Invoice';
            ...
            column(CustomerNo; header."Bill-to Customer No.")
            {
            ...
            column(PaymentDescription; header."Payment Terms Code")
            {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                // added by atif
                column(Unit_of_Measure; Line."Unit of Measure")
                {
    ...
    begin
        //Ashish - with SalesHeader do begin
    ...
    begin
        FormatAddr.GetCompanyAddr(SalesHeader."Responsibility Center", RespCenter, CompanyInformation, CompanyAddress);
        FormatAddr.SalesHeaderBillTo(CustomerAddress, SalesHeader);
        ShowShippingAddr := FormatAddr.SalesHeaderShipTo(ShipToAddr, CustomerAddress, SalesHeader);
        ShowShippingAddr := True;
        OnAfterFormatAddressFields(ShipToAddr, CustomerAddress, SalesHeader, ShowShippingAddr);
    end;
